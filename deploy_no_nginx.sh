...
sudo systemctl status streamlit-stat-deces --no-pager -l | head -n 15
echo ""
echo "Commandes utiles:"
echo "   Voir les logs:  sudo journalctl -u streamlit-stat-deces -f"
echo "   Redemarrer:     sudo systemctl restart streamlit-stat-deces"
echo "   Arreter:        sudo systemctl stop streamlit-stat-deces"
